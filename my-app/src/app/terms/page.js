...
export default function Terms() {
    return (
        <div className="w-full max-w-[95%] md:max-w-[50%] mx-auto py-10 px-4 text-[var(--foreground)]">
            <h1 className="text-3xl font-semibold mb-2">Terms & Conditions</h1>
            <p className="text-sm text-[var(--foreground-secondary)] mb-8">Last updated on 30-01-2026 23:02:07</p>

            <div className="space-y-6 text-[var(--foreground-secondary)]">
                <p>
                    These Terms and Conditions, along with privacy policy or other terms (“Terms”) constitute a binding
                    agreement by and between GARAGA PAVAN KARTHIK, ( “Website Owner” or “we” or “us” or “our”)
                ...
                <ul className="list-disc pl-5 space-y-4">
                    ...
                    <li>
                        ...
                        jurisdiction of the courts in Mandapeta, Andhra Pradesh
                    </li>
                    <li>
